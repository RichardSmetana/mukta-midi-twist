...
//   USB CDC On Boot: Disabled  (USB/Serial start in sketch — better for CDC+MIDI composite)
//   Upload Mode:     USB-OTG CDC (TinyUSB)
// Port in IDE: the "USB Serial Device" / TinyUSB CDC port, NOT "USB JTAG/serial debug unit".
// Upload fallback: hold BOOT (GPIO 0) for 2 seconds to enter bootloader.
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
// GPIO — ESP32-S3 (each pin must be unique; avoid 0, 19, 20, 43, 44, 45, 46)
// -----------------------------------------------------------------------------
// Encoder 0
const uint8_t ENC0_PIN_CLK = 4;
const uint8_t ENC0_PIN_DT = 5;
const uint8_t BTN0_PIN_SW = 6;

// Encoder 1
const uint8_t ENC1_PIN_CLK = 7;
const uint8_t ENC1_PIN_DT = 8;
const uint8_t BTN1_PIN_SW = 9;

// Encoder 2
const uint8_t ENC2_PIN_CLK = 10;
const uint8_t ENC2_PIN_DT = 11;
const uint8_t BTN2_PIN_SW = 12;
...
const uint8_t NEOPIXEL_BRIGHTNESS = 255;
const uint8_t LED_MIDI_CHANNEL = 1;
const uint8_t LED_INIT_SPEED = 50;
const uint8_t LED_INIT_BRIGHT = 31;
